...
type Walking struct {
	Training
	PersonHeight float64 // рост пользователя
}
...
func (w Walking) Calories() float64 {
	...
	HeightInMeters := w.PersonHeight / CmInM
...
func (s Swimming) SwimmingDistance() float64 {
...
func ReadData(training CaloriesCalculator) string {
	...
	// полученние калорий в структуру с информацией о тренировке
